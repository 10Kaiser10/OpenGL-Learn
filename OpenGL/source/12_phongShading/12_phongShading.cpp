...
int main(void)
{
    ...
    //shaders
    std::string sourceVertPath = "../../../source/12_phongShading/sourceVertex.shader";
    std::string sourceFragPath = "../../../source/12_phongShading/sourceFragment.shader";
    std::string objectVertPath = "../../../source/12_phongShading/objectVertex.shader";
    std::string objectFragPath = "../../../source/12_phongShading/objectFragment.shader";
    ...
    glm::vec4 objectColor = glm::vec4(1.0, 0.6, 0.6, 1.0);
    glm::vec3 lightPos = glm::vec3(2.0f, 3.0f, 3.0f);
    ...
    glUniform3fv(glGetUniformLocation(objectShaderProg, "lightPos"), 1, glm::value_ptr(lightPos));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, 0.0f * (float)glfwGetTime() * glm::radians(-40.0f), glm::vec3(0.0, 1.0, 0.0));
        ...
        glUniformMatrix3fv(glGetUniformLocation(objectShaderProg, "normalMat"), 1, false, glm::value_ptr(normalMat));
        glUniform3fv(glGetUniformLocation(objectShaderProg, "eyePos"), 1, glm::value_ptr(cam->getPosition()));
