...
int main(void)
{
    ...
    //shader stuff
    std::string vertPath = "../../../source/06_transformed/vertex.shader";
    std::string fragPath = "../../../source/06_transformed/fragment.shader";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniformMatrix4fv(glGetUniformLocation(shaderProg, "transform"), 1, false, glm::value_ptr(trans));
